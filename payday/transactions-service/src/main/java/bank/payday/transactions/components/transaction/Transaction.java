...
public class Transaction {
    ...
    public Transaction(String description, int customer, int account, long id, int amount, String dateOfTransaction) {
        this.account            = account;
        this.amount             = amount;
        this.dateOfTransaction   = Long.parseLong(dateOfTransaction);
        this.customer              = customer;
        this.description         = description;
